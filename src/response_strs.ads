...
package response_strs is
   ...
   --and MAX_RESPONSE_LENGTH must be updated 
   MAX_STATUS_AND_HEADERS_LENGTH : constant Natural := 
      HTTP_VERSION_10_STR'Length + STATUS_LINE_500_STR'Length + CRLF'Length +
      --http/1.0
      ALLOW_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      AUTHORIZATION_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      CONTENT_ENCODING_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      CONTENT_LENGTH_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      CONTENT_TYPE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      DATE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      EXPIRES_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      FROM_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      IF_MODIFIED_SINCE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      LAST_MODIFIED_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      LOCATION_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      PRAGMA_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      REFERER_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      SERVER_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      USER_AGENT_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      WWW_AUTHENTICATE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      ACCEPT_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      ACCEPT_CHARSET_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      ACCEPT_ENCODING_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      ACCEPT_LANGUAGE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      CONTENT_LANGUAGE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      LINK_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      RETRY_AFTER_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      TITLE_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      URI_HEADER_STR'Length + COLON_SPACE'Length + MAX_HEADER_VALUE_BYTE_CT + CRLF'Length +
      CRLF'LENGTH;
